const ptBr = {
  ...
  register: {
    ...
    access_here: ' Acesse aqui',
    voluntary_register: 'Cadastro de voluntário',
    organization_register: 'Cadastro de organização',
  ...
  location_service: {
    access_denied: 'O acesso à localização foi negado',
  },
}
